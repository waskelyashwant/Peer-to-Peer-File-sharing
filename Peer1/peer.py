...
class Peer:
    ...
    def toListBlockFile(self, last, begin):
        for i in range(begin, last):
            file = open("D:\Work\ComputerNetwork\P2P\Peer1\PEER2Dir/" + str(i) + ".pdf.chk", 'rb')
    ...
    def __getBootStrap(self):
        ...
        sepDir = os.path.join("D:\Work\ComputerNetwork\P2P/Peer1/" + sepDir)
    ...
    def __performAfterCheckChunk(self):
        file = os.path.join("D:\Work\ComputerNetwork\P2P/Peer1/" + self.merge_file_name)
    ...
    def checkChunk(self):
        ...
        try:
            ...
            print(len(self.list_block_file))
        except:
    ...
    def __processChunk(self):
        ...
        chunks = []
        chunks = self.skt_dwn.recv(1024).decode('utf-8')
        chunks = eval(chunks)
        print("yele chunks", chunks)
