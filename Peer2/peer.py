...
class Peer:
    ...
    def toListBlockFile(self, last, begin):
        for i in range(begin, last):
            file = open("D:\Work\ComputerNetwork\P2P\Peer2\PEER3Dir/" + str(i) + ".pdf.chk", 'rb')
    ...
    def __getBootStrap(self):
        ...
        sepDir = os.path.join("D:\Work\ComputerNetwork\P2P/Peer2/" + sepDir)
    ...
    def __performAfterCheckChunk(self):
        file = os.path.join("D:\Work\ComputerNetwork\P2P/Peer2/" + self.merge_file_name)
